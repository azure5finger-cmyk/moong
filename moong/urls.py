...
urlpatterns = [
    ...
    re_path(r'^post/(?P<post_id>\d+)/apply/$', views.post_apply, name='participation_apply'),
    re_path(r'^post/(?P<post_id>\d+)/cancel/$', views.post_cancel, name='participation_cancel'),
    ...
    re_path(r'^participation/(?P<participation_id>\d+)/manage/', views.participant_manage, name='participant_manage'),
